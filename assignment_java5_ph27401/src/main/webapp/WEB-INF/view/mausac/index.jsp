...
<%--<button id="myButton" onclick="ht()">Hiển thị bảng</button>--%>
<table class="table" id="myTable" >
    ...
    <c:forEach items="${lophocPage.content}" var="cv" varStatus="i">
        <tr>
            ...
            <td>${cv.ten}</td>
            <td>
                <a href="/mau-sac/update/${cv.id}" class="btn btn-success">update</a>
                <a href="/mau-sac/delete/${cv.id}" class="btn btn-success">delete</a>
            </td>
        </tr>
    </c:forEach>
    </tbody>
