...
<section class="add">
    ...
    <form:form action="/sanpham/add" method="post" modelAttribute="sp">
...
<table class="table">
    ...
    <c:forEach items="${lophocPage.content}" var="cv" varStatus="i">
        <tr>
            ...
            <td>
                <a href="/sanpham/update/${cv.id}" class="btn btn-success">update</a>
                <a href="/sanpham/delete/${cv.id}" class="btn btn-success">delete</a>
            </td>
        </tr>
    </c:forEach>
    </tbody>
